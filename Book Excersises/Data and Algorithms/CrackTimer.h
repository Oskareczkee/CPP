...
public:
	...
	/// </summary>
	enum TimeUnit {NANOSECONDS = 0, MICROSECONDS = 1, MILISECONDS = 2, SECONDS = 3, MINUTES = 4, HOURS = 5, DAY=6};
	...
	double ShowTime(TimeUnit TimeUnit=SECONDS)
	{
		ElapsedTime = End - Start;
		switch (TimeUnit)
		{
		case CrackTimer::NANOSECONDS:
			return ElapsedTime.count() * 1000000000;
			break;
		case CrackTimer::MICROSECONDS:
			return ElapsedTime.count() * 1000000;
			break;
		case CrackTimer::MILISECONDS:
			return ElapsedTime.count() * 1000;
			break;
		case CrackTimer::SECONDS:
			return ElapsedTime.count();
			break;
		case CrackTimer::MINUTES:
			return ElapsedTime.count()/60;
			break;
		case CrackTimer::HOURS:
